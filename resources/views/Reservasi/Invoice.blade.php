        ...
        <div class=" bg-white rounded-md shadow-md p-3">
            ...
            <div class="">
                ...
                <h1 class="border-b-2 border-black">
                    Down Payment 50% Rp. {{ number_format($total, 2, ',', '.') }}
            ...
            <div class="flex mt-4 w-full ">
                <a class=" text-center text-primary border-primary border-2 py-1 mr-4 rounded-lg px-2 w-full"
                    href="{{ route('pesanan.reservasi.list', ['id' => $pesanan->id]) }}">Kembali</a>
                <button id="pay-button"
                    class="bg-primary text-white py-1  rounded-lg px-2 w-full text-center  ">Bayar</button>
